...
describe('Phase 4: Server Integration Tests', () => {
  ...
  describe('Complete Game Flow', () => {
    it('should handle complete 3-leg match', () => {
      ...
      state = {
        ...state,
        players: [{ ...state.players[0], score: 50 }, state.players[1]],
      };
      ...
      state = {
        ...state,
        players: [state.players[0], { ...state.players[1], score: 75 }],
      };
      ...
      state = {
        ...state,
        players: [{ ...state.players[0], score: 100 }, state.players[1]],
      };
    ...
    it('should handle close match with leg lead changes', () => {
      ...
      state = {
        ...state,
        players: [state.players[0], { ...state.players[1], score: 100 }],
      };
      ...
      state = {
        ...state,
        players: [{ ...state.players[0], score: 75 }, state.players[1]],
      };
      result = dispatchMessage(state, { type: 'score', data: { value: 75 } });
      state = result.gameState;
      expect(state.players[0].legs).toBe(1);
      ...
      state = {
        ...state,
        players: [state.players[0], { ...state.players[1], score: 150, legs: 1 }],
      };
      result = dispatchMessage(state, { type: 'score', data: { value: 150 } });
      state = result.gameState;
  ...
  describe('State Persistence Across Rounds', () => {
    it('should maintain player names across rounds', () => {
      ...
      // Update names
      let result = dispatchMessage(state, {
        type: 'updateName',
        data: { playerIndex: 0, name: 'Alice' },
      });
      state = result.gameState;
      result = dispatchMessage(state, {
        type: 'updateName',
        data: { playerIndex: 1, name: 'Bob' },
      });
      state = result.gameState;
  ...
  describe('Average Calculation and Statistics', () => {
    it('should calculate correct average across multiple darts', () => {
      ...
      state = {
        ...state,
        players: [
          { ...state.players[0], score: 441, dartsThrown: 0, totalScored: 0 },
          state.players[1],
        ],
      };

      const result = dispatchMessage(state, { type: 'score', data: { value: 60 } });
      state = result.gameState;
    ...
    it('should track total scored and darts thrown', () => {
      ...
      state = {
        ...state,
        players: [
          { ...state.players[0], score: 451, dartsThrown: 0, totalScored: 0 },
          state.players[1],
        ],
      };
  ...
  describe('Game Reset', () => {
    it('should fully reset game to initial state', () => {
      ...
      state = {
        ...state,
        players: [
          { ...state.players[0], score: 100, legs: 2 },
          { ...state.players[1], score: 200, legs: 1 },
        ],
      };
    ...
    it('should preserve player names on reset', () => {
      ...
      state = {
        ...state,
        players: [{ ...state.players[0], score: 100, legs: 2 }, state.players[1]],
      };
  ...
  describe('Transaction Safety', () => {
    it('should not partially update state on error', () => {
      ...
      // Try invalid update
      const result = dispatchMessage(state, {
        type: 'updateName',
        data: { playerIndex: 999, name: 'Invalid' },
      });
